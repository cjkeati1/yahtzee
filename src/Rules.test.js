...
it('works for three of kind', () => {
    expect(threeOfKind.evalRoll([1, 1, 1, 2, 2])).toEqual(3);
    expect(threeOfKind.evalRoll([1, 1, 1, 1, 1])).toEqual(3);
    expect(threeOfKind.evalRoll([1, 1, 3, 2, 2])).toEqual(0);
});

it('works for four of kind', () => {
    expect(fourOfKind.evalRoll([1, 1, 1, 1, 2])).toEqual(4);
    expect(fourOfKind.evalRoll([1, 1, 1, 1, 1])).toEqual(4);
